...
By default, summarization is done using `mean`. However, the `summary_function` argument can be set to 'median', 'sd', 'var', 'mad', 'max', or 'min' in order to perform any of those alternate summarizations. We can also use the `layout` argument to pass a title to the new axis.    
